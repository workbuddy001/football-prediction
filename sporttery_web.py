            ...
            try {
                ...
                overlay.innerHTML = '<div class="v36-modal">'
                    ...
                    + (a.betting ? (function() {
                        ...
                        const goalColors = {'R0':'#e91e63','R1':'#4caf50','R3':'#ff9800','R4':'#2196f3','F':'#ff5722','S1':'#ff9800','G4':'#ff9800','G5':'#e91e63','G6':'#9c27b0','G7':'#ff5722','H3':'#e040fb','H2':'#e91e63','H1':'#00bcd4'};
                        ...
                        const roiMap = {'R0':'+164%','R1':'+300%','R3':'+56%','R4':'探索中','F':'+275%','S1':'+155%','G4':'+122%','G5':'+135%','G6':'+298%','G7':'+550%','H3':'+405%','H2':'+275%','H1':'+263%'};
