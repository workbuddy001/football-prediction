            ...
            try {
                ...
                overlay.innerHTML = '<div class="v36-modal">'
                    ...
                    + (a.betting ? (function() {
                        ...
                        const goalColors = {'R0':'#e91e63','R1':'#4caf50','R2':'#9c27b0','R3':'#ff9800','R4':'#2196f3','F':'#ff5722','G4':'#ff9800','G5':'#e91e63','G6':'#9c27b0','G7':'#ff5722','H2':'#e91e63','H1':'#00bcd4'};
                        ...
                        const roiMap = {'R0':'+164%','R1':'+300%','R2':'探索中','R3':'+56%','R4':'探索中','F':'+275%','G4':'+122%','G5':'+135%','G6':'+298%','G7':'+550%','H2':'+231%','H1':'+171%'};
