...
matches_310 = [
    ...
    {"id": "周二009", "match": "纽卡斯尔 vs 巴萨", "v7": "客胜", "confidence": 62, "home_rate": 50, "away_rate": 70, "eight_change": -2, "actual": "平局", "score": "1-1"},
]

# 3.11比赛数据
matches_311 = [
    {"id": "周三001", "match": "神户胜利 vs 首尔FC", "v7": "主胜", "confidence": 58, "home_rate": 60, "away_rate": 50, "eight_change": 2, "actual": "主胜", "score": "2-1"},
    {"id": "周三002", "match": "广岛三箭 vs 柔佛", "v7": "主胜", "confidence": 75, "home_rate": 70, "away_rate": 20, "eight_change": 0, "actual": "主胜", "score": "1-0"},
    {"id": "周三003", "match": "叻武里 vs 大阪钢巴", "v7": "客胜", "confidence": 72, "home_rate": 20, "away_rate": 60, "eight_change": 1, "actual": "平局", "score": "1-1"},
    {"id": "周三004", "match": "勒沃库森 vs 阿森纳", "v7": "主胜", "confidence": 65, "home_rate": 80, "away_rate": 70, "eight_change": 3, "actual": "平局", "score": "1-1"},
    {"id": "周三005", "match": "诺维奇 vs 谢菲联", "v7": "主胜", "confidence": 55, "home_rate": 50, "away_rate": 40, "eight_change": -2, "actual": "主胜", "score": "2-1"},
    {"id": "周三006", "match": "西布罗姆 vs 南安普敦", "v7": "客胜", "confidence": 58, "home_rate": 40, "away_rate": 50, "eight_change": 1, "actual": "平局", "score": "1-1"},
    {"id": "周三007", "match": "博德闪耀 vs 里斯本", "v7": "客胜", "confidence": 62, "home_rate": 90, "away_rate": 70, "eight_change": -3, "actual": "主胜", "score": "3-0"},
...
print("\n【详细表格】")
print("-" * 110)
print(f"| 日期 | 编号 | 对阵 | 置信度 | 8变化 | 状态 | 规律 | 推荐 | 实际 | 比分 | 结果 |")
print(f"|------|------|------|--------|-------|------|------|------|------|------|------|")
...
for r in results:
    ...
    actual = r['actual'] or "-"
    score = r['score'] or "-"
    print(f"| {date} | {r['id']} | {r['match']} | {r['confidence']}% | {r['eight']:+d} | {r['state']} | {r['rule']} | {r['rec']} | {actual} | {score} | {hit_mark} |")

# 统计
total = len([r for r in results if r['actual']])
hits = sum(1 for r in results if r['hit'] and r['actual'])
