...
if __name__ == "__main__":
    predictions_313 = load_predictions("3.13_V15预测.txt")
    predictions_314 = load_predictions("3.14_V15预测.txt")
    predictions_315 = load_predictions("3.15_V15预测.txt")
    
    print("=" * 60)
    print("V15 预测结果比对 (末位8探测准则)")
    print("=" * 60)
