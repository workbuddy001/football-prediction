...
# 3.17 - 根据之前分析，8变化是各选项的变化
# 周一001: 客胜8从7降到2 = -5（减少最多）
# 周一004: 三个选项各+1
# 周一006: 三个选项各+1

# 3.17 比赛数据 - 胜率差需要重新计算
# 周一001 海尔蒙特vs坎布尔: 主20% 客70% 差-50%
# 周一004 布伦特vs狼队: 主40% 客30% 差+10%
# 周一006 巴列卡诺vs莱万特: 主43% 客14% 差+29%

# 3.17 比赛完整数据
matches_317 = [
    ("3.17", "周一001", "海尔蒙特 vs 坎布尔", "客胜", 58, -50, 0, 0, -5, "客胜"),  # 客胜8减少最多=-5
    ("3.17", "周一004", "布伦特 vs 狼队", "主胜", 64, +10, +1, +1, +1, "平局"),  # 三个都+1，选主胜
    ("3.17", "周一006", "巴列卡诺 vs 莱万特", "主胜", 55, +29, +1, +1, +1, "平局"),  # 三个都+1，选主胜
]
