...
if __name__ == "__main__":
    predictions_313 = load_predictions("3.13_V16预测.txt")
    predictions_314 = load_predictions("3.14_V16预测.txt")
    predictions_315 = load_predictions("3.15_V16预测.txt")
    
    print("=" * 60)
    print("V16 预测结果比对 (V7 + 8探测)")
    print("=" * 60)
