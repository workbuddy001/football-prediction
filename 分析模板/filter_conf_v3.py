...
print('Confidence > 55%: {} matches'.format(len(results)))
print()
print('='*130)
print('%-6s %-10s %-28s %-6s %-8s %-8s %-15s %-6s %-6s %-8s %-4s' % ('Date', 'Num', 'Match', 'V7', 'Conf', 'Diff', '8-Chg', 'Final', 'Act', 'Score', 'Res'))
print('='*130)
...
print('='*130)
if len(results) > 0:
    print('Hit: {}/{} ({:.1f}%)'.format(hit, len(results), hit/len(results)*100))
