...
RAW_HTML    = f"d:\\work\\workbuddy\\足球预测\\分析模板\\page_raw_2026-03-19.html"
OUT_JSON    = f"d:\\work\\workbuddy\\足球预测\\分析模板\\matches_full_2026-03-19.json"
...
def parse_ouzhi(fixture_id):
    ...
    for row in rows:
        ...
        if not name or '公司' in name:
            continue
        companies.append({
            '公司': name,
            '初盘胜': strip_tags(row[1]),
