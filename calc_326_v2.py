...
# -*- coding: utf-8 -*-
"""
3.26比赛数据分析 - 应用3.28优化版筹码分流系统(A-G七维度)
"""
...
matches_data = [
    {
        ...
        "away_form": "WLWWDL",
        "macao_tip": "主队",
        "official_odds": (1.98, 3.72, 2.82),
        "initial_avg": (1.50, 4.20, 5.75),
        "realtime_avg": (1.44, 4.80, 6.50),
    },
    {
        "id": "周四002",
        "home": "意大利",
        ...
        "away_form": "WLLWLW",
        "macao_tip": "主队",
        "official_odds": (1.69, 3.65, 3.80),
        "initial_avg": (1.29, 5.00, 9.50),
        "realtime_avg": (1.27, 5.35, 11.50),
    },
    {
        "id": "周四003",
        "home": "斯洛伐克",
        ...
        "away_form": "DWWDWL",
        "macao_tip": "客队",
        "official_odds": (4.50, 3.75, 1.56),
        "initial_avg": (1.90, 3.30, 4.00),
        "realtime_avg": (2.25, 3.05, 3.45),
    },
    {
        "id": "周四004",
        "home": "威尔士",
        ...
        "away_form": "DWWDLW",
        "macao_tip": "主队",
        "official_odds": (3.08, 3.15, 2.05),
        "initial_avg": (1.95, 3.30, 4.00),
        "realtime_avg": (1.73, 3.60, 4.90),
    },
    {
        "id": "周四005",
        "home": "波兰",
        ...
        "away_form": "LWWWWW",
        "macao_tip": "主队",
        "official_odds": (2.75, 3.15, 2.23),
        "initial_avg": (1.70, 3.50, 5.20),
        "realtime_avg": (1.70, 3.50, 5.40),
    },
    {
        "id": "周四006",
        "home": "捷克",
        ...
        "away_form": "WWWLLD",
        "macao_tip": "客队",
        "official_odds": (3.55, 3.35, 1.82),
        "initial_avg": (1.93, 3.35, 3.80),
        "realtime_avg": (1.93, 3.40, 4.00),
    },
    {
        "id": "周四007",
        "home": "丹麦",
        ...
        "away_form": "LDDDWL",
        "macao_tip": "和局",
        "official_odds": (1.55, 3.90, 4.40),
        "initial_avg": (1.30, 5.10, 9.50),
        "realtime_avg": (1.22, 6.10, 13.00),
    },
    {
        "id": "周四008",
        "home": "巴西",
        ...
        "away_form": "WWDWWW",
        "macao_tip": "客队",
        "official_odds": (1.56, 3.85, 4.37),
        "initial_avg": (3.20, 3.35, 2.10),
        "realtime_avg": (2.85, 3.55, 2.25),
    },
    {
        "id": "周四009",
        "home": "玻利维亚",
        ...
        "away_form": "LWDDWD",
        "macao_tip": "主队",
        "official_odds": (4.85, 3.45, 1.58),
        "initial_avg": (2.15, 3.20, 3.20),
        "realtime_avg": (2.25, 2.95, 3.30),
    },
    {
        "id": "周四010",
        "home": "哥伦比亚",
        ...
        "away_form": "WWWDWW",
        "macao_tip": "和局",
        "official_odds": (4.35, 3.55, 1.62),
        "initial_avg": (2.20, 3.30, 3.00),
        "realtime_avg": (2.13, 3.35, 3.20),
    },
    {
        "id": "周四011",
        "home": "新喀里多尼亚",
        ...
        "away_form": "WDDWLW",
        "macao_tip": "客队",
        "official_odds": (1.75, 5.10, 2.76),
        "initial_avg": (22.00, 9.00, 1.08),
        "realtime_avg": (30.00, 12.00, 1.04),
    },
    {
        "id": "周四012",
        "home": "智利",
        ...
        "away_form": "",
        "macao_tip": "未知",
        "official_odds": (3.27, 3.20, 1.96),
        "initial_avg": (1.80, 3.40, 4.20),
        "realtime_avg": (1.88, 3.30, 4.15),
    },
]
...
def analyze_chips_flow(m, h_score, a_score, form_diff):
    ...
    """
    odds_h, odds_d, odds_a = m["official_odds"]
...
def main():
    print("=" * 80)
    print("3.26比赛数据分析 - 3.28优化版筹码分流系统(A-G七维度)")
    print("=" * 80)
    ...
    for m in matches_data:
        ...
        # 计算置信度
        conf_h, conf_d, conf_a, max_conf, conf_dir = calc_confidence(*m["official_odds"])
    ...
    for r in results:
        ...
        print(f"  C.赔率最低: {a['min_odds_dir']} (赔付压力最小)")
